...
function AirbnbButton(){
    ...
    const handleMouseMove = (e) => {
      ...
      button.querySelector('.hover-effect').style.transform = 'translate(-50%, -50%) scale(1)';
    };
    ...
    const handleMouseLeave = () => {
      ...
      button.querySelector('.hover-effect').style.transform = 'translate(-50%, -50%) scale(0)';
    };
  ...
  return (
    <section className="app-header full main-layout flex column ">
      ...
      <div className="main-header-mobile flex align-center space-between">
