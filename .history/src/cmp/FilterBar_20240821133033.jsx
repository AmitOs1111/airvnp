...
export function FilterBar({
  ...
  return (
    <section className="filter-bar ">
      <div className="filter-bar-content active flex align-center">
        <div
        ...
        <div
          className="filter-bar-item check-in-out-search flex align-center space-around"
        ...
        <div
          className="filter-bar-item who-search active flex  space-between align-center"
