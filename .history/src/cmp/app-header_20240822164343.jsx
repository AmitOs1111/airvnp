...
import { ImgCarousel } from './img-carousel.jsx'
...
export function AppHeader() {
  ...
  // const [loggedinUser, setLoggedinUser] = useSelector()
  ...
  function openNavMenu() {
    ...
    setOpenNavMenu((prevOpenOpenNavMenu) => !prevOpenOpenNavMenu)
  }
    ...
    <section className="app-header full main-layout flex column ">
      <div className="main-header flex space-between align-center">
        ...
        <div className="container-user-header flex space-between">
          ...
          >
            ...
            <div className="svg-user">
              {user ? (
                <img
                  className="img-user"
                  src={require(`../assets/img/img-user/user2.png`)}
                  alt="user"
                />
              ) : (
                <svg
          ...
          {OpenNavMenu && <NavMenu openNavMenu={openNavMenu} />}
        </div>
      </div>
