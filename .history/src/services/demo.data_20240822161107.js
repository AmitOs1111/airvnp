...
const dataStays = [
  {
    ...
    type: ['Campers', 'Icons', 'Amazing views', 'National parks'],
    imgUrls: [
  ...
  },
  {
    ...
    type: ['Campers', 'Icons', 'Amazing views', 'OMG!'],
    imgUrls: [
    ...
    reviews: [
      ...
      },
      {
        ...
        txt: "J'ai adoré rester là. Très acceuillngt.",
      },
      {
  ...
  },
  {
    ...
    type: ['Campers', 'Icons', 'National parks'],
    imgUrls: [
    ...
    reviews: [
      ...
      },
      {
        ...
        txt: "Shaila and Alex are wonderful hosts really, they helped us every time we needed with directions, the internet, the supermarket, the post office !!! (thank you guys !!!).The place and the neighbord are great, 8 blocks far from the apartment you have the subway and 30 min. later you are in the islngd, we moved early in the morning, late at night (sometimes we came back at 2am) and everything turned out great.Definetly I would come back to their apartment, It's bigger than ours in Argentina !!! I look forward to stay there again and, next time, go out with you guys and have a beer or anything.\r\nBye !!! - Guido and Carla - ",
      },
      {
  ...
  {
    _id: '622f337a75c7d36e498sdvaaafc',
    name: 'Habitación centro de Barcelona',
    type: ['Campers', 'National parks'],
    imgUrls: [
      'http://res.cloudinary.com/dmtlr2viw/image/upload/v1663436983/pivldxmrxssnhyzixhes.jpg',
  ...
  {
    _id: '622f337a75c7d36e498aaadcvdfc',
    name: 'Habitación centro de Barcelona',
    type: ['Campers', 'National parks'],
    imgUrls: [
      'http://res.cloudinary.com/dmtlr2viw/image/upload/v1663436983/pivldxmrxssnhyzixhes.jpg',
